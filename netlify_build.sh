...
mamba install -c conda-forge -c bioconda snakemake r-blogdown=0.21 r-rmarkdown=2.6 r-knitr=1.28 r-xfun r-bookdown=0.17 r-tidyverse r-cowplot r-remotes r-tufte=0.8;
