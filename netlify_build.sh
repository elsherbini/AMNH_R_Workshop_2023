...
mamba install -c conda-forge -c bioconda snakemake  r-colorspace r-patchwork r-codetools r-palmerpenguins r-naniar r-blogdown r-ggforce r-ggridges r-tidyverse r-tufte r-cowplot;
