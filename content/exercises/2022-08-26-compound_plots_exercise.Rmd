---
title: Compound Plots Exercise
author: Claus Wilke remixed by Joseph Elsherbini
description: Compound Plots Exercise
date: '2022-08-26'
slug: compound-plots-exercise
categories: ['exercise']
math: true
output:
  tufte::tufte_html:
...
# make the following 4 plots we'll use to arrange in patchwork
p1 <- ggplot(mtcars) + 
  geom_point(aes(mpg, disp))
...
```{r temperatures, evale=TRUE, echo = TRUE}
mtcars
```
