...
<pre class="r">
<code class="language-r">
`r ''````{r singlet-plots, fig.width = 4, fig.height = 0.618*4}
p1 <- ggplot(mtcars) + 
  geom_point(aes(mpg, disp))
p1  
...
```{r singlet-plots, echo = FALSE, eval=TRUE, message = FALSE, fig.width = 4, fig.height = 0.618*4}
p1 <- ggplot(mtcars) + 
  geom_point(aes(mpg, disp))
p1  
...
# if you have trouble loading a dataset there, ask in the discord!
```