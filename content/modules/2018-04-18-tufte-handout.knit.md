...
<!--
<div class="figure">-->
<img src="2018-04-18-tufte-handout_files/figure-html/fig-margin-1.png" alt="MPG vs horsepower, colored by transmission." width="336"  />
<!--
...
<label for="tufte-mn-" class="margin-toggle">&#8853;</label><input type="checkbox" id="tufte-mn-" class="margin-toggle"><span class="marginnote"><span style="display: block;">We know from <em>the first fundamental theorem of calculus</em> that
for <span class="math inline">\(x\)</span> in <span
class="math inline">\([a, b]\)</span>:</span>
<span style="display: block;"><span class="math display">\[\frac{d}{dx}\left( \int_{a}^{x}
f(u)\,du\right)=f(x)\]</span></span></span>
...
<div class="figure">
<img src="2018-04-18-tufte-handout_files/figure-html/fig-fullwidth-1.png" alt="A full width figure." width="960" />
<p class="caption">(\#fig:fig-fullwidth)A full width figure.</p>
</div>
...
<div class="figure">
<img src="2018-04-18-tufte-handout_files/figure-html/fig-main-1.png" alt="A figure in the main column." width="672" />
<p class="caption">(\#fig:fig-main)A figure in the main column.</p>
</div>
...
<div class="figure">
<img src="2018-04-18-tufte-handout_files/figure-html/fig-two-together-1.png" alt="Two plots in one figure environment." width="672" /><img src="2018-04-18-tufte-handout_files/figure-html/fig-two-together-2.png" alt="Two plots in one figure environment." width="672" />
<p class="caption">(\#fig:fig-two-together)Two plots in one figure environment.</p>
</div>
...
<div class="figure">
<img src="2018-04-18-tufte-handout_files/figure-html/fig-two-separate-1.png" alt="Two plots in separate figure environments (the first plot)." width="672" />
<p class="caption">(\#fig:fig-two-separate-1)Two plots in separate figure environments (the first plot).</p>
</div>
...
<div class="figure">
<img src="2018-04-18-tufte-handout_files/figure-html/fig-two-separate-2.png" alt="Two plots in separate figure environments (the second plot)." width="672" />
<p class="caption">(\#fig:fig-two-separate-2)Two plots in separate figure environments (the second plot).</p>
</div>
...
<!--
<div class="figure">-->
<img src="2018-04-18-tufte-handout_files/figure-html/fig-margin-together-1.png" alt="Two plots in one figure environment in the margin." width="336"  /><img src="2018-04-18-tufte-handout_files/figure-html/fig-margin-together-2.png" alt="Two plots in one figure environment in the margin." width="336"  />
<!--
<p class="caption marginnote">-->Two plots in one figure environment in the margin.<!--</p>-->
<!--</div>--></span></p>
...
<!--
<div class="figure">-->
<img src="2018-04-18-tufte-handout_files/figure-html/fig-margin-separate-1.png" alt="Two plots in separate figure environments in the margin (the first plot)." width="336"  />
<!--
<p class="caption marginnote">-->Two plots in separate figure environments in the margin (the first plot).<!--</p>-->
<!--</div>--></span></p>
...
<!--
<div class="figure">-->
<img src="2018-04-18-tufte-handout_files/figure-html/fig-margin-separate-2.png" alt="Two plots in separate figure environments in the margin (the second plot)." width="336"  />
<!--
<p class="caption marginnote">-->Two plots in separate figure environments in the margin (the second plot).<!--</p>-->
<!--</div>--></span></p>
...
<!--
<div class="figure">-->
<img src="2018-04-18-tufte-handout_files/figure-html/fig-nocap-margin-1.png" alt=" " width="336"  />
<!--
...
<img src="2018-04-18-tufte-handout_files/figure-html/fig-nocap-main-1.png" width="672" />
...
<img src="2018-04-18-tufte-handout_files/figure-html/fig-nocap-fullwidth-1.png" width="960" />
